...
PieceShape occupied_cells(const GameplayData& data, const FallingPiece& piece) {
    // Translate the piece-local 4x4 shape into board coordinates.
...
std::array<Block, 4> blocks_for(const FallingPiece& piece) {
    // Most pieces use one tile; the I piece preserves its directional end caps.
    switch (piece.kind) {
    case PieceKind::L:
        return {Block::l, Block::l, Block::l, Block::l};
    case PieceKind::J:
        return {Block::j, Block::j, Block::j, Block::j};
    case PieceKind::O:
        return {Block::o, Block::o, Block::o, Block::o};
    case PieceKind::S:
        return {Block::s, Block::s, Block::s, Block::s};
    case PieceKind::Z:
        return {Block::z, Block::z, Block::z, Block::z};
    case PieceKind::T:
        return {Block::t, Block::t, Block::t, Block::t};
    case PieceKind::I: {
        const bool vertical = piece.rotation == Rotation::right || piece.rotation == Rotation::left;
        if (vertical) {
            return {Block::i_vertical_first, Block::i_vertical_middle, Block::i_vertical_middle,
                    Block::i_vertical_last};
        }
        return {Block::i_horizontal_first, Block::i_horizontal_middle, Block::i_horizontal_middle,
                Block::i_horizontal_last};
    }
    }
    return {};
}
